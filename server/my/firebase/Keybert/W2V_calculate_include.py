...
## Word2Vec
df = pd.DataFrame()
with open('kakao_concat.txt', 'r', encoding='UTF-8') as file:
    for line in file:
        line_data = {'sentence': line}  # dict
...
df_new = df['sentence'].apply(preprocessing)
#print(df_new)

tokenizer = RegexTokenizer()
tokens = df_new.apply(tokenizer.tokenize)  # 리스트로 저장됨
#print(tokens)

model_W2V = word2vec.Word2Vec(tokens, min_count=1)
model_W2V_name = 'model_W2V'
model_W2V.save(model_W2V_name)
#print(model_W2V)
